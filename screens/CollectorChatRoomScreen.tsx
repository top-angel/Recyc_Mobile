...
const CollectorChatRoom: FC = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-02-purple-mission">
      ...
      <KeyboardAvoidingView
        className="flex-1 bg-02-purple-mission mt-3"
        ...
        >
          <>
            ...
            <ChatCardHeader
              ...
              headerBackground="rgba(16, 24, 40, 0.7)"
            />
            <ScrollView
              className="flex-1 p-0 bg-[#101828]/[0.5]"
              scrollEnabled
              ref={chatRef}
              ...
              <View className="flex-1 p-4 ">
                {chatMessages.map((message) => (
                  <ChatSingleMessage
                    ...
                    message={message}
                    icon={room?.icon}
                    backgroundColor="#1C3C59"
                  />
                ))}
              </View>
            </ScrollView>

            <View className="bg-[#101828]/[0.5] p-4">
              <ChartSendMessage
...
export default memo(CollectorChatRoom);
